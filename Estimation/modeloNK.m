...
estim_params_.param_vals = [estim_params_.param_vals; 5, NaN, NaN, NaN, 3, 1.5, 0.05, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 6, NaN, NaN, NaN, 2, 0.25, 0.1, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 1, NaN, NaN, NaN, 1, 0.5, 0.25, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 9, NaN, NaN, NaN, 1, 0.5, 0.25, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 10, NaN, NaN, NaN, 1, 0.5, 0.25, NaN, NaN, NaN ];
...
options_.mh_nblck = 2;
options_.mh_replic = 4000;
options_.mode_check.status = 1;
options_.mode_compute = 4;
options_.datafile = 'matlab';
options_.order = 1;
var_list_=[];
